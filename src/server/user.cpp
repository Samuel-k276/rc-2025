 ...
 */
void add_user(std::string uid, std::string password) { users[uid] = User{uid, password, true}; }

/**
 * Remove a user from the system
 * @param uid: user ID
 */
void remove_user(std::string uid) { users.erase(uid); }
 ...
 */
User &get_user(std::string uid) { return users[uid]; }
 ...
 */
bool is_user_registered(std::string uid) { return users.find(uid) != users.end(); }
 ...
 */
bool is_user_logged_in(std::string uid) { return get_user(uid).is_logged_in; }

/**
 * Login a user
 * @param uid: user ID
 */
void login_user(std::string uid) { get_user(uid).is_logged_in = true; }
